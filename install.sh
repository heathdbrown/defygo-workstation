...
sudo apt-get -y install chromium-browser build-essential bison openssl libreadline6 libreadline6-dev curl git-core zlib1g zlib1g-dev libssl-dev libyaml-dev libsqlite3-0 libsqlite3-dev sqlite3 libxml2-dev libxslt-dev postgresql-8.4 postgresql-common postgresql-client-8.4 libpq-dev
 autoconf libc6-dev meld
